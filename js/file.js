...
var File = /** @class */ (function () {
    function File(path) {
        this.rename = this.moveTo;
        this.getJson = this.readJson; //aka
    ...
    File.prototype.paramDir = function () {
        var _this = this;
    ...
    File.prototype.readAsBase64 = function () {
        return this.read().then(function (buffer) { return buffer.toString(); });
...
exports.File = File;
//synchron
var FileSync = /** @class */ (function () {
    function FileSync(path) {
        this.rename = this.moveTo;
        this.path = path;
    }
